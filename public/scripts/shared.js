/* ============================================================
   ...
   USAGE: Loaded site-wide by Base.astro before page scripts.
   Exposes window.RZ.* helpers; pages call the ones they need.
   ============================================================ */
...
// Auto-init: theme must run before first paint (Base.astro also inlines a pre-paint guard)
RZ.initTheme();
